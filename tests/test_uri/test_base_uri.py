...
class TestBaseURI(unittest.TestCase):
    def test_uri(self):
        ...
        self.assertEqual('/test-uri-path?key1=value1&key2=value2', TestURI.uri(key1='value1', key2='value2'))
    ...
    def test_full_uri(self):
        ...
        self.assertEqual('http://domain.com/test-uri-path?key1=value1&key2=value2', TestURI.full_uri(key1='value1', key2='value2'))
        ...
        self.assertEqual('https://domain.com/test-uri-path?key1=value1&key2=value2', TestURI.full_uri(key1='value1', key2='value2'))
